...
class TestResource(TestCase):
    ...
    def test_make_request_raises_vercel_error(self, mock_request):
        mock_request.side_effect = [
            MockResponse({"error": {"code": "error_code", "message": "Error Message"}})
        ]
    ...
    def test_make_request_handles_unexpected_error(self, mock_request):
        mock_request.side_effect = [Exception("other-exception")]
    ...
    def test_make_request_honors_headers_and_params(self, mock_request):
        ...
        assert mock_request.mock_calls == [
            call(
                ...
                params={"teamId": "fake-team-id", "Another": False},
            )
        ]
    ...
    def test_make_paginated_request(self, mock_request):
        mock_request.side_effect = [
            MockResponse({"response": [{"id": "1"}], "pagination": {"next": "2"}}),
            MockResponse({"response": [{"id": "2"}], "pagination": {"next": "3"}}),
            MockResponse({"response": [{"id": "3"}]}),
        ]

        result = vercel.Resource.make_paginated_request(
            resource="/v2/domains", response_key="response"
        )
        ...
        assert mock_request.mock_calls == [
            ...
            call(
                ...
                params={"teamId": "fake-team-id", "since": "3"},
            ),
        ]
    ...
    def test_make_paginated_request_honors_headers_and_params(self, mock_request):
        ...
        assert mock_request.mock_calls == [
            call(
                ...
                params={"limit": 10, "teamId": "fake-team-id"},
            ),
            call(
                url="https://api.vercel.com/v2/domains",
                method="GET",
                ...
                params={"limit": 10, "teamId": "fake-team-id", "since": "2"},
            ),
            call(
                url="https://api.vercel.com/v2/domains",
                method="GET",
                ...
                params={"limit": 10, "teamId": "fake-team-id", "since": "3"},
            ),
        ]
