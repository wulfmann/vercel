...
class TestProjects(TestCase):
    ...
    def test_create_env_var_v4(self, mock_request):
        mock_v1_get = Path('tests/fixtures/responses/projects/v1/get.json')
        mock_v4_create_env_var = Path('tests/fixtures/responses/projects/v4/create_env_var.json')
    ...
    def test_delete_env_var_v4(self, mock_request):
        mock_v1_get = Path('tests/fixtures/responses/projects/v1/get.json')
        mock_v4_delete_env_var = Path('tests/fixtures/responses/projects/v4/create_env_var.json')
        ...
        project = vercel.Project.get('test-project')
        project.delete_environment_variable(
            key='my-var',
            target='production'
        )
    ...
    def test_add_domain_v1(self, mock_request):
        mock_v1_get = Path('tests/fixtures/responses/projects/v1/get.json')
        mock_v1_add_domain = Path('tests/fixtures/responses/projects/v1/add_domain.json')
    ...
    def test_remove_domainv1(self, mock_request):
        mock_v1_get = Path('tests/fixtures/responses/projects/v1/get.json')
        mock_v1_remove_domain = Path('tests/fixtures/responses/projects/v1/remove_domain.json')
    ...
    def test_redirect_domain_v1(self, mock_request):
        mock_v1_get = Path('tests/fixtures/responses/projects/v1/get.json')
        mock_v1_redirect_domain = Path('tests/fixtures/responses/projects/v1/redirect_domain.json')
